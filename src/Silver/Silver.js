...
export default function Silver() {
    ...
    return (
        <>
            <Container className="Silver-main-container mt-4">
                <Row>
                                            ...
                                            <Card className="Card" style={{width:'345px'}}>
                                                ...
                                                <CardActions>
                                                    <Button style={{ backgroundColor: '#832f37', alignItems: 'center', display: 'flex', justifyContent: 'center', width: '100%', transition: 'background-color 2.3s' }} variant="contained" size="small">
                                                        <NavLink style={{textDecoration:"none", color:'white'}} className='Silver-navlink' key={e.id} to={`/SingleProduct/${e.id}`}>
                                                            Buy Now
                                                        </NavLink>
                                                    </Button>
                    ...
                    <Col className='xyz' style={{ height: '900px', padding: '1rem' }} lg={3}>
                        ...
                        <div className="Silver-category " style={{ display: 'grid', justifyContent: 'left', gap: '25px', paddingLeft: '20px' }}>
                            <h4 className='my-4' style={{ cursor: 'pointer', fontWeight: 400 }} onClick={getData}>CATEGORY</h4>
                            <button className='filter-all-btn' type='button' name='Silver Ring' onClick={handleCategory1}>Ring</button>
                            <button className='filter-all-btn' type='button' name='Silver Earring' onClick={handleCategory1}>Earring</button>
                            <button className='filter-all-btn' type='button' name='Silver Necklace' onClick={handleCategory1}>Necklace</button>
                        </div>
