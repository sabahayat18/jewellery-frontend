...
export default function Diamond() {
    ...
    return (
        <>
            <Container className="Diamond-main-container mt-4">
                <Row>
                                        ...
                                        <div className="sort-selection">
                                            <form action="#">
                                                ...
                                                <select name="sort" onChange={handleData}
                                                    ...
                                                    <option className="diamond-option" value="highest">Price(highest)</option>
                                                </select>
                                            </form>
                                        </div>
                                    </Col>
                                    ...
                                    return (
                                        <Col className="my-3 d-flex" lg={4} style={{ justifyContent: 'center' }}>
                                            <Card className="Card" style={{width:'345px'}}>
                                                ...
                                                <Divider />
                                                <CardActions>
                                                <NavLink style={{textDecoration:"none", color:'white', width: '100%'}} className='diamond-navlink' key={e.id} to={`/SingleProduct/${e.id}`}>
                    ...
                    <Col className='xyz' style={{ height: '900px', padding: '1rem' }} lg={3}>
                        ...
                        <div className="diamond-category " style={{ display: 'grid', justifyContent: 'left', gap: '25px', paddingLeft: '20px' }}>
                            <h4 className='my-4' style={{ cursor: 'pointer', fontWeight: 400 }} onClick={getData}>CATEGORY</h4>
                            <button className='filter-all-btn' type='button' name='Diamond Ring' onClick={handleCategory1}>Ring</button>
                            <button className='filter-all-btn' type='button' name='Diamond Earring' onClick={handleCategory1}>Earring</button>
                            <button className='filter-all-btn' type='button' name='Diamond Necklace' onClick={handleCategory1}>Necklace</button>
                        </div>
